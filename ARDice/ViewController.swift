...
//MARK: - Dice Rendering Methods
    ...
    func addDice(atLocation location:ARHitTestResult) {
        ...
        let diceScene = SCNScene(named: "artisan.scnassets/diceCollada.scn")!
    ...
    // Rolling all our dices again
    @IBAction func rollAgain(_ sender: UIBarButtonItem) {
        rollAll()
    }
    
    // Rollin all our dices when we shaking our phone
    override func motionEnded(_ motion: UIEvent.EventSubtype, with event: UIEvent?) {
        rollAll()
    }
    
    @IBAction func removaAllDice(_ sender: UIBarButtonItem) {
